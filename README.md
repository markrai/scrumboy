...
- Advanced filtering: the default compact Omni control keeps ordinary text search while offering matching active project tags beside the field; applied tags compose with sprint and other URL filters. The previous permanent tag/sprint pills remain available as **Legacy pills** under Settings → Customization.
