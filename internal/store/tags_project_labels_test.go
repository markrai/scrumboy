...
func TestProjectLabels_CanonicalFilterMatchesGroupedCount(t *testing.T) {
	...
	for _, filter := range []string{"make-space", "make space"} {
		_, _, _, cols, err := st.GetBoard(ctx1, &pc, []string{filter}, "", AssigneeFilter{}, PriorityFilter{}, SprintFilter{Mode: "none"}, SortOrderDefault)
		if err != nil {
		...
		_, _, _, pagedCols, meta, err := st.GetBoardPaged(ctx1, &pc, []string{filter}, "", AssigneeFilter{}, PriorityFilter{}, SprintFilter{Mode: "none"}, SortOrderDefault, 10)
		if err != nil {
		...
		items, _, _, err := st.ListTodosForBoardLane(ctx1, p.ID, DefaultColumnBacklog, 10, math.MinInt64, 0, []string{filter}, "", AssigneeFilter{}, PriorityFilter{}, SprintFilter{Mode: "none"}, SortOrderDefault)
		if err != nil {
		...
		count, err := st.CountTodosForBoardLane(ctx1, p.ID, DefaultColumnBacklog, []string{filter}, "", AssigneeFilter{}, PriorityFilter{}, SprintFilter{Mode: "none"})
		if err != nil {
	...
	page1, cursor, hasMore, err := st.ListTodosForBoardLane(ctx1, p.ID, DefaultColumnBacklog, 1, math.MinInt64, 0, []string{"make-space"}, "", AssigneeFilter{}, PriorityFilter{}, SprintFilter{Mode: "none"}, SortOrderDefault)
	if err != nil {
	...
	page2, _, _, err := st.ListTodosForBoardLane(ctx1, p.ID, DefaultColumnBacklog, 1, afterRank, afterID, []string{"make-space"}, "", AssigneeFilter{}, PriorityFilter{}, SprintFilter{Mode: "none"}, SortOrderDefault)
	if err != nil {
	...
	_, _, _, emptyCols, err := st.GetBoard(ctx1, &pc, []string{"no-such-tag"}, "", AssigneeFilter{}, PriorityFilter{}, SprintFilter{Mode: "none"}, SortOrderDefault)
	if err != nil {
	...
	emptyCount, err := st.CountTodosForBoardLane(ctx1, p.ID, DefaultColumnBacklog, []string{"no-such-tag"}, "", AssigneeFilter{}, PriorityFilter{}, SprintFilter{Mode: "none"})
	if err != nil {
...
func TestProjectLabels_TemporaryBoardFilterStaysRowLevel(t *testing.T) {
	...
	for _, tc := range cases {
		_, _, _, cols, err := st.GetBoard(ctx1, &pc, []string{tc.filter}, "", AssigneeFilter{}, PriorityFilter{}, SprintFilter{Mode: "none"}, SortOrderDefault)
		if err != nil {
		...
		_, _, _, pagedCols, meta, err := st.GetBoardPaged(ctx1, &pc, []string{tc.filter}, "", AssigneeFilter{}, PriorityFilter{}, SprintFilter{Mode: "none"}, SortOrderDefault, 10)
		if err != nil {
		...
		items, _, _, err := st.ListTodosForBoardLane(ctx1, p.ID, DefaultColumnBacklog, 10, math.MinInt64, 0, []string{tc.filter}, "", AssigneeFilter{}, PriorityFilter{}, SprintFilter{Mode: "none"}, SortOrderDefault)
		if err != nil {
		...
		count, err := st.CountTodosForBoardLane(ctx1, p.ID, DefaultColumnBacklog, []string{tc.filter}, "", AssigneeFilter{}, PriorityFilter{}, SprintFilter{Mode: "none"})
		if err != nil {
...
func TestProjectLabels_UncanonicalizableRowStaysAddressable(t *testing.T) {
	...
	_, _, _, cols, err := st.GetBoard(ctx1, &pc, []string{legacyName}, "", AssigneeFilter{}, PriorityFilter{}, SprintFilter{Mode: "none"}, SortOrderDefault)
	if err != nil {
