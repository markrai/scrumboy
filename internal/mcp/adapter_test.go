...
func TestMCPSystemGetCapabilities_FullPreBootstrap(t *testing.T) {
	...
	wantTools := []any{
		...
		"todos_create", "todos_get", "todos_search", "todos_update", "todos_countCompleted", "todos_delete", "todos_archive", "todos_restore", "todos_move", "todos_linksList", "todos_linkAdd", "todos_linkRemove",
