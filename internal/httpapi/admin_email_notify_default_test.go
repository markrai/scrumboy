...
func TestAdminEmailNotifyDefault_GetDefaultsToHardcodedFallback(t *testing.T) {
	...
	if out["value"] != `{"v":1,"enabled":false,"assigned":true,"createdByMe":true,"cardActivity":false,"sprintActivity":false,"projectActivity":false,"addedToProject":true}` {
...
func TestAdminEmailNotifyDefault_PutRequiresAdminOrOwnerAndSeedsNewUsers(t *testing.T) {
	...
	if pref["value"] != `{"v":1,"enabled":true,"assigned":true,"createdByMe":true,"cardActivity":false,"sprintActivity":false,"projectActivity":true,"addedToProject":true}` {
...
func TestAdminEmailNotifyDefault_DeleteResetsToUnset(t *testing.T) {
	...
	if beforePref["value"] != `{"v":1,"enabled":true,"assigned":true,"createdByMe":true,"cardActivity":false,"sprintActivity":false,"projectActivity":true,"addedToProject":true}` {
