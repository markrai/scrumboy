...
const BOOTSTRAP_EN_CATALOG: MessageCatalog = {
  ...
  "board.filters.clearTag": "Clear tag filter {name}",
  ...
  "tooltips.boardSearch": "Search titles and notes. Combine with tag, sprint, and other filters to narrow the board.",
