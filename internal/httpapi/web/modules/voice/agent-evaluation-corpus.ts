import type { VoiceAgentEvaluationCase } from './agent-evaluation.js';
 ...
 */
export const VOICE_AGENT_EVALUATION_CASES: readonly VoiceAgentEvaluationCase[] = Object.freeze([
  {
