...
import { getAssigneeFromUrl, getAuthStatusAvailable, getProjectId, getSlug, getTag, getSearch, getSprintIdFromUrl, getUser, } from '../state/selectors.js';
...
function flushPendingRealtimeRefresh(force = false) {
    ...
    invalidateBoard(slug, getTag(), getSearch(), getSprintIdFromUrl(), getAssigneeFromUrl()).catch((err) => {
