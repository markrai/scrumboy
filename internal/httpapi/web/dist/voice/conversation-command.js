import { canRunResolvedVoiceCommand, getActiveVoiceCommandContext, resolveParsedVoiceDraft, } from './command-resolution.js';
...
export async function resolveVoiceConversationCommand(intent, session, options, signal, targetOverride) {
    ...
    const target = resolveConversationTodoTarget(targetInput, session.getState(), {
