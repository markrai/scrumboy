...
export const INTERPRETATION_LAB_CURRENT_PROFILE = 'current-v2';
export const INTERPRETATION_LAB_EXPERIMENTAL_PROFILE = 'experimental-v3';
export const INTERPRETATION_LAB_CANDIDATE_PROFILE = 'candidate-v3';
...
export function interpretationLabInstructions(profile) {
    switch (profile) {
