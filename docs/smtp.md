...
| `SCRUMBOY_ENCRYPTION_KEY`  | Reset tokens can't be signed; `selfServicePasswordResetEnabled` stays `false` even with SMTP fully configured. Generate on Linux/Windows: [FAQ](../FAQ.md#how-do-i-generate-scrumboy_encryption_key). Also [`docs/environment-variables.md`](environment-variables.md#scrumboy_encryption_key).                                                                                                                                                                                |
